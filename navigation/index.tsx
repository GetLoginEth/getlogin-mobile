...
import DAppAuthorizationModalScreen from '../screens/DAppAuthorizationModalScreen'
  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Group screenOptions={{ presentation: 'modal' }}>
        ...
        <Stack.Screen name="ImportMnemonic" component={ImportMnemonicModalScreen} options={{ headerShown: false }} />
        <Stack.Screen
          name="CreateWallet"
        ...
        <Stack.Screen
          ...
          component={DAppAuthorizationModalScreen}
